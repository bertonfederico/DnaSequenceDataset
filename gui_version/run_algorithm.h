...
class RunAlgorithm : public QObject
{
    Q_OBJECT
...
public:
    ...
    void prepareOutputCsvFile(ofstream &csvOut, bool hasUniqueTable);
...
signals:
    void testValueChanged(bool isFull, bool isIterate, int newValue);
