...
void MainWindow::on_select_input_clicked()
{
    QString fileName = QFileDialog::getOpenFileName(this, "Choose File");
    ui->input_file_field->setText(fileName);
...
void MainWindow::on_select_output_clicked()
{
    QString folderName = QFileDialog::getExistingDirectory(this, "Choose Folder");
    ui->output_file_field->setText(folderName);
